...
public final class Expense implements Comparable<Expense>, Parcelable {
    ...
    public static final class Builder {
        ...
        private Builder(Expense expense) {
            ...
            mDestination = expense.getDestination();
        }
    ...
    public boolean equals(Object o) {
        ...
        if (mReceipt != null ? !mReceipt.equals(expense.mReceipt) : expense.mReceipt != null) return false;
        return !(mDestination != null ? !mDestination.equals(expense.mDestination) : expense.mDestination != null);
    }
    ...
    protected Expense(Parcel in) {
        ...
        mDestination = in.readParcelable(Destination.class.getClassLoader());
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(mDestination, 0);
    }
